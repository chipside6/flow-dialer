          ...
          <div className="py-10 px-8 md:w-2/3">
            <div className="space-y-4">
              ...
              <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:space-x-3 mt-6">
                <Button 
                  className="bg-green-600 hover:bg-green-700 w-full sm:w-auto py-6 px-6 h-auto text-base font-medium"
                  onClick={handleCreateCampaign}
                >
                  <PlusCircle className="h-5 w-5 mr-2" />
                  Create First Campaign
                </Button>
                <Button variant="outline" className="w-full sm:w-auto py-6 h-auto" onClick={() => navigate('/features')}>
