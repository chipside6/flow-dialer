    ...
    return (
      <input
        ...
        className={cn(
          ...
          isFileInput && "text-sm file:mr-2 file:py-1.5 file:px-2 file:rounded-md file:text-xs file:font-medium file:whitespace-nowrap file:overflow-hidden file:text-ellipsis",
          className
        )}
