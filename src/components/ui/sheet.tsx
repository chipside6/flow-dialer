  ...
  (
    ...
    <SheetPortal hideOverlay={hideOverlay}>
      ...
      <SheetPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 h-full border-r bg-background p-6 shadow-lg ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
