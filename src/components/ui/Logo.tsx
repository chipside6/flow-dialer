...
export const Logo = ({ size = "md", withText = true, className }: LogoProps) => {
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <div className={cn(logoSize, "relative flex-shrink-0 rounded-full bg-primary/10")}>
        <img 
      ...
      {withText && (
        <span className={cn(`font-display ${textSize} font-bold tracking-tight whitespace-nowrap`, 
