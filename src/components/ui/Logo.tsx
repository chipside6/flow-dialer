...
export const Logo = ({ size = "md", withText = true, className }: LogoProps) => {
  ...
  return (
    <div className={cn("flex items-center gap-2 w-full overflow-hidden", className)}>
      <div className={cn(logoSize, "relative rounded-full flex-shrink-0 p-0")}>
        <img 
      ...
      {withText && (
        <span className={cn(`font-display ${textSize} font-bold tracking-tight drop-shadow-sm truncate`, 
